...
function responder(bla) {
    ...
    if(bla.id === 'presente indicativo') {
        ...
        if (largura > 600) {
            ...
            document.getElementById("passado indicativo").style = " background-color: var(--amarelo_escuro1); font-size:1.2em"
            document.getElementById("futuro indicativo").style = " background-color: var(--amarelo_escuro1); font-size:1.2em"
    ...
    if(bla.id === "pretérito imperfeito indicativo") {
        ...
        if (largura > 600) {
            ...
            bla.style = "background-color: var(--destaque); font-size: 1.2em"
    ...
    if(bla.id === "pretérito imperfeito subjuntivo") {
        ...
        if (largura > 600) {
            ...
            document.getElementById("presente subjuntivo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
            document.getElementById("futuro subjuntivo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
    ...
    if(bla.id === "presente subjuntivo") {
        ...
        if (largura > 600) {
            bla.style = "background-color: var(--destaque);; font-size:1.4em"
            document.getElementById("pretérito imperfeito subjuntivo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
            document.getElementById("futuro subjuntivo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
    ...
    if(bla.id === "positivo imperativo") {
        ...
        if (largura > 600) {
            bla.style = "background-color: var(--destaque); font-size:1.4em"
            document.getElementById("negativo imperativo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
    ...
    if(bla.id === "negativo imperativo") {
        ...
        if (largura > 600) {
            bla.style = "background-color: var(--destaque); font-size:1.4em"
            document.getElementById("positivo imperativo").style = "background-color: var(--amarelo_escuro1); font-size:1.2em"
...
function modo_indicativo() {
    ...
    if (largura > 600) {
        document.getElementById("modo_indicativo").style = "font-size: 1.6em; background-color: var(--destaque)"
        document.getElementById("modo_subjuntivo").style = "font-size: 1.4em"
        document.getElementById("modo_imperativo").style = "font-size: 1.4em"
...
function passado_ind() {
    ...
    if (largura > 600) {
        ...
        document.getElementById("futuro indicativo").style = " background-color: var(--amarelo_escuro1); font-size:1.2em"
        document.getElementById("presente indicativo").style = " background-color: var(--amarelo_escuro1); font-size:1.2em"
...
function modo_subjuntivo() {
    ...
    if (largura > 600) {
        ...
        document.getElementById("modo_indicativo").style = "font-size: 1.4em"
        document.getElementById("modo_subjuntivo").style = "font-size: 1.6em; background-color: var(--destaque)"
        document.getElementById("modo_imperativo").style = "font-size: 1.4em"
...
function modo_imperativo() {
    ...
    if (largura > 600) {
        ...
        document.getElementById("modo_indicativo").style = "font-size: 1.4em"
        document.getElementById("modo_imperativo").style = "font-size: 1.6em; background-color: var(--destaque)"
        document.getElementById("modo_subjuntivo").style = "font-size: 1.4em"
...
function gerar_verbo_aleatorio() {
    ...
    restore_modos()
    document.getElementById("botao_jogo_verbos").style.visibility = "visible"
    limpar_resultado()
